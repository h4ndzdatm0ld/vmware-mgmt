...
build {
  ...
  provisioner "shell" {
    ...
    scripts           = ["${abspath(path.root)}/scripts/cleanup-root.sh", "${abspath(path.root)}/scripts/iac.sh", "${abspath(path.root)}/scripts/ssh.sh", "${abspath(path.root)}/scripts/setup.sh", "${abspath(path.root)}/scripts/docker.sh", "${abspath(path.root)}/scripts/docker-compose.sh", "${abspath(path.root)}/scripts/python-utils.sh"]
